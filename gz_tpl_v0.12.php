...
class gz_tpl{
	...
	function init_path_1(){
		//Init path
		$reflector = new ReflectionClass($this->id);
		$file_name = $reflector->getFileName();
		$file_name = str_replace('/mnt/c/Dropbox/www_wsl/_dev/monitor.wsl09.gizmo-thailand.com/','/mnt/f/www_dev/monitor.wsl09.gizmo-thailand.com/htdocs/',$file_name);
		...
		/*
		die('<pre>'.print_r([
		    '.'				=> realpath('wp/wp-content/plugins/_gizmo/'),
		    '..'			=> realpath('..'),
