...
function load_module($prm){
    ...
    switch($prm_type){
        case 'lib0': $path = '_lib/'.$prm_name.$prm_version.'.php'; break;
        case 'lib':  $path = '_lib/'.$prm_name.$prm_version.'/_wp_class.php'; break;
        default:     $path = '_sys/'.$prm_type.'/'.$prm_name.$prm_version.'/_wp_class.php';
    }
    //if(empty($prm_action)){
