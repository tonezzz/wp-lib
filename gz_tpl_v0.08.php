...
class gz_tpl{
	...
	private function init(){
		//if(isset($this->config['shortcodes'][0]['prm'][0]) && ($this->config['shortcodes'][0]['prm'][0]=='r2p_remove_spam_image')) die('<pre>'.print_r($this->config['shortcodes'],true));
		//if(isset($this->config['shortcodes'])) die('<pre>'.print_r($this->config['shortcodes'],true));
		...
		if(isset($this->config['taxonomies']))		add_action('wp_loaded',[$this,'init_taxonomies']);
	}
	...
	public function init_filters(){//die(__FILE__);
	 ...
	 *	]
	 */
	public function init_shortcodes(){//die('<pre>'.print_r($shortcodes,true));
