(function( $ ) {
	...
	$('document').ready(function(){//var maps = []; console.log($( '.cmb-type-pw-map' ));
	...
	function initializeMap( mapInstance ) {
		...
		var zoom = 5; //console.log(searchInput);
		...
		var map = new google.maps.Map( mapCanvas[0], mapOptions ); //console.log(map);
