...
////////////////////////////////////////////////
var my={};
//console.log('[gz_panel]',options,this);
//alert($(this).attr('class'));
////

//if(my.debug.init)console.log('[o]',$(this).attr('class'));
//if(my.debug.init)console.log('[x]',$(this).attr('class'));
...
this.prepare = function(){
	...
	//$(this).on('get_store', function(e){if(my.debug.get_store)console.log('[get_store]',my.store,this); return my.store;});
	//console.log('[prepare]',this,my);
}

this.reload = function(e){
	var _type = my.$this.attr('data-type');
	var prms  = my.$this.attr('data-prms');
	//console.log('[reload]',_type,this);
	switch(_type){
		case 'panel'://console.log(my.debug);
			this.do_ajax(my.ajax_url,{action:my.$this.attr('data-action') ,prms:prms}
				,function(rs){//console.log(my.debug);
					my.$this.html(rs.html); //if(my.debug.reload_panel)console.log('[reload,panel]',my.$this.find('.gz_panel'));
					my.$this.find('.gz_panel').gz_panel({ajax_url: my.ajax_url});
					my.$this.find('.gz_panel').gz_panel('load');
				}
			);
			break;
	}
